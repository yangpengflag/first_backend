 ...
 *
 * <p>照 {@code TravelExceptionHandler} 的分域 advice 模式：{@code @Order} 最高优先级 + 限定
 * 本模块包路径，把三类错误转统一信封（含 request_id），且不影响其它模块的 400 校验语义：
 * <ul>
...
@RestControllerAdvice(basePackages = "com.mooc.backend.ai")
