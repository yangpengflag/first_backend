...
import com.mooc.backend.controller.TravelController;

import com.fasterxml.jackson.databind.ObjectMapper;

import com.mooc.backend.filter.RateLimitFilter;
import com.mooc.backend.config.RateLimitProperties;
...
@Import({com.mooc.backend.config.SecurityConfig.class,
...
class TravelControllerTest {
    ...
    static class FilterConfig {
        ...
        JwtAuthFilter jwtAuthFilter() {
            return new JwtAuthFilter(org.mockito.Mockito.mock(com.mooc.backend.service.TokenService.class));
        }

        @Bean
        UserStatusFilter userStatusFilter(ObjectMapper objectMapper) {
            return new UserStatusFilter(org.mockito.Mockito.mock(com.mooc.backend.repository.UserRepository.class),
    ...
    void publicEndpointsListContainsNoMcpPaths() {
        org.assertj.core.api.Assertions.assertThat(com.mooc.backend.config.SecurityConfig.PUBLIC_ENDPOINTS)
